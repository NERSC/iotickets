...
#SBATCH -p regular
#SBATCH -J lx13.nspc2.SO0.db128.b1.078125
#SBATCH -S 4
...
# Job info
echo "input file: lx13.nspc2.SO0.db128.b1.078125.in"
...
# Run the application
srun -n 50 -c 16 --cpu_bind=cores lafmc mc lx13.nspc2.SO0.db128.b1.078125.in
